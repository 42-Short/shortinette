...
export const meta: MetaFunction = () => {
  return [
    ...
    {
      name: "description",
      content: "Welcome to the website of the 42 Vienna Student Council.",
    },
  ];
};
      ...
      <div className="flex flex-col md:flex-row md:items-center">
        ...
        <div className="mx-4">
          <div className="mb-4">
            ...
            <p>
              We are students who have been elected by you and your peers. We
              represent the student body in the school's decision making
              process. This platform allows you to anonymously share thoughts,
              ideas, and concerns with the community. While your submissions
              remain anonymous to the public, the student council members will
              know who submitted what, to ensure accurate and effective
              representation.
            </p>
          </div>
          <div>
            ...
            <ul className="ml-4">
              <li>
                Because we want{" "}
                <span className="font-bold">everyone to be heard</span>.
              </li>
              <li>
                Because we want{" "}
              ...
              <li>
                Because we want{" "}
                <span className="font-bold">to make a difference</span>.
              </li>
            </ul>
          </div>
        </div>
