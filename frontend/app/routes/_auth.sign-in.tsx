  ...
  return (
    <div className="self-center flex flex-col justify-center items-center h-screen mx-8">
      ...
      <p className="mt-4 text-center">
        In order to provide a secure and private platform, we only allow
        students of 42 Vienna to access our portal.
      </p>
      <div className="w-80 mt-4 flex flex-col justify-center items-center space-y-4">
        {data.oauthFailed && (
          <Alert variant="destructive">
            ...
            <AlertDescription>
              We were unable to complete your sign-in request. Please try again
              in a few minutes. If the issue persists please contact us on
              Discord.
            </AlertDescription>
          </Alert>
        )}
          ...
          <Alert variant="destructive">
            ...
            <AlertDescription>
              ...
              <span className="font-bold">
                42 Vienna Student Council Website
              </span>{" "}
              is only accessible to{" "}
              <span className="font-bold">42 Vienna Students</span>. We don't
              allow anyone else to access our platform.
            </AlertDescription>
          </Alert>
        )}
